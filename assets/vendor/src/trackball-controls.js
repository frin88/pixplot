...
THREE.TrackballControls = function (object, domElement) {
  ...
  function keydown(event) {
    ...
    // firing at SHIFT // nb can't use ctrl or outer page zoom is fired
    if (event.keyCode === 16) {
      //_this.domElement.addEventListener('mousedown', mousedown, eventBindType);
      _this.domElement.addEventListener('wheel', mousewheel, eventBindType);
    }
  ...
  function keyup(event) {
   ...
   // _this.domElement.removeEventListener('mousedown', mousedown, eventBindType);
    _this.domElement.removeEventListener('wheel', mousewheel, eventBindType);
  }
